<template>
  <div class="d-flex flex-column justify-center align-center" style="height: 70vh;">
    ...
    <p class="text-h5">{{ translate("store-module.throw-wrong") }}, <strong class="cursor-pointer" @click="fireEvent('refresh-store-items')">{{ translate("try-again").toLowerCase() }}</strong>.</p>
  </div>
</template>